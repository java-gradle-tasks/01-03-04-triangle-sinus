   ...
   public class TestInputText {
      ...
      public void test() {
         ...
         String expected="Adja meg a haromszog a oldalat:Adja meg a haromszog b oldalat:Adja meg az gamma szoget (fok):";
         ...
         Assertions.assertTrue(found,"Nem a megfelelo szoveggel kerte be a feladatot!");
      }
   }
